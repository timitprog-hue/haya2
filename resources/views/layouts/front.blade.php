...
<head>
    ...
    {{-- CSS + JS dari Vite (hasil build ada di public/build) --}}
        ...
        <footer class="footer-glass mt-auto py-3">
            <div class="container d-flex flex-column flex-md-row justify-content-between align-items-center gap-2">
                <span class="text-muted small">
                    <span class="lang-id">© {{ date('Y') }} Haya Dev — Website, Aplikasi & Otomasi Industri</span>
                    <span class="lang-en">© {{ date('Y') }} Haya Dev — Websites, Apps & Industrial Automation</span>
                </span>
                <span class="text-muted small">
