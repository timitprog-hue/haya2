<!DOCTYPE html>
<html lang="{{ app()->getLocale() }}" data-theme="dark" data-lang="{{ app()->getLocale() }}">
<head>
    <meta charset="utf-8" />
    ...
    {{-- Bootstrap & custom CSS (pindahkan file2 ini ke public/) --}}
    <link rel="stylesheet" href="{{ asset('lib/bootstrap/dist/css/bootstrap.min.css') }}" />
    <link rel="stylesheet" href="{{ asset('css/site.css') }}" />
    <link rel="stylesheet" href="{{ asset('haya.styles.css') }}" />
</head>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="mainNavbar">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0 gap-lg-2">
                        <li class="nav-item">
                            <a class="nav-link nav-link-scroll active"
                               href="#home"
                               data-target="home">
                        ...
                        <li class="nav-item">
                            <a class="nav-link nav-link-scroll"
                               href="#about"
                               data-target="about">
        ...
        <footer class="footer-glass mt-auto py-3">
            <div class="container d-flex flex-column flex-md-row justify-content-between align-items-center gap-2">
                <span class="text-muted small">
                    <span class="lang-id">© {{ now()->year }} Haya Dev — Website, Aplikasi &amp; Otomasi Industri</span>
                    <span class="lang-en">© {{ now()->year }} Haya Dev — Websites, Apps &amp; Industrial Automation</span>
                </span>
                <span class="text-muted small">
